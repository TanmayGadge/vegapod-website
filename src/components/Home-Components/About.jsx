...
const About = () => {
  return (
    <>
      <section className=" bg-primary-800 text-light-100 flex justify-center p-4 py-32">
        <div className="max-w-7xl font-extralight selection:bg-light-100 selection:text-primary-800 space-y-8">
